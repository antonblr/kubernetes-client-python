...
class V1AzureFilePersistentVolumeSource(ModelNormal):
    ...
    def _from_openapi_data(cls, secret_name, share_name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            secret_namespace (str): secretNamespace is the namespace of the secret that contains Azure Storage Account Name and Key default is the same as the Pod. [optional]  # noqa: E501
        """
