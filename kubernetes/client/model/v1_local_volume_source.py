...
class V1LocalVolumeSource(ModelNormal):
    ...
    def _from_openapi_data(cls, path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            fs_type (str): fsType is the filesystem type to mount. It applies only when the Path is a block device. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". The default value is to auto-select a filesystem if unspecified.. [optional]  # noqa: E501
        """
