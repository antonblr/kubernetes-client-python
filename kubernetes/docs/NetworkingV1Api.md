...
> V1NetworkPolicy patch_namespaced_network_policy_status(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.patch_namespaced_network_policy_status(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1NetworkPolicy read_namespaced_network_policy_status(name, namespace)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.read_namespaced_network_policy_status(name, namespace)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
...
> V1NetworkPolicy replace_namespaced_network_policy_status(name, namespace, body)
...
with kubernetes.client.ApiClient(configuration) as api_client:
    ...
    # example passing only required values which don't have defaults set
    try:
        api_response = api_instance.replace_namespaced_network_policy_status(name, namespace, body)
        pprint(api_response)
    except kubernetes.client.ApiException as e:
