...
> V1CSIStorageCapacity create_namespaced_csi_storage_capacity(namespace, body)
...
> V1CSIStorageCapacity patch_namespaced_csi_storage_capacity(name, namespace, body)
...
> V1CSIStorageCapacity read_namespaced_csi_storage_capacity(name, namespace)
...
> V1CSIStorageCapacity replace_namespaced_csi_storage_capacity(name, namespace, body)
